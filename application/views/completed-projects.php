...
.animate-card.active {
    ...
    transform: translateX(0); /* Reset transform */
        ...
        <div class="container d-flex flex-column flex-md-row mt-3 main-container">
                                ...
                                <div class="col-md-8 p-0">
                                    <div class="cards-body d-flex flex-column" style="height: 100%;">
                                        ...
                                        <p class="card-text mb-5">
                                            ...
                                            <a href="<?php echo base_url('ghm/offshore_project');?>" class="service-read">READ MORE...</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8 p-0">
                                    <div class="cards-body d-flex flex-column justify-content-between" style="height: 100%;">
                                        ...
                                        <p class="card-text mb-5"> <a href="<?php echo base_url('ghm/tanker_project');?>" class="service-read">READ MORE...</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="cards-body d-flex flex-column justify-content-between" style="height: 100%;">
                                        ...
                                        <p class="card-text mb-5"> <a href="<?php echo base_url('ghm/bulk_carrier_projects');?>" class="service-read">READ MORE...</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="cards-body d-flex flex-column justify-content-between" style="height: 100%;">
                                        ...
                                        <p class="card-text mb-5 mt-4"> <a href="<?php echo base_url('ghm/consultancy_project');?>" class="service-read">READ MORE...</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form_container order-1 order-md-2 mt-5 animate-card" data-direction="right">
